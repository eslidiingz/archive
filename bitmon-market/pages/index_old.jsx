                  ...
                  <table width="100%" className="balance-table">
                      ...
                      <td align="left">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="text-blue mb-0">1925 USD</p>
                          </div>
                        </div>
                      </td>
                      <td align="right">3694.2547</td>
                    </tr>
                    <tr>
                      <td align="left">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="text-blue mb-0">2659 USD</p>
                          </div>
                        </div>
                      </td>
                      <td align="right">12.0254</td>
                    </tr>
                    <tr>
                      <td align="left">
                        <div className="d-flex">
                    ...
                    <tr>
                      ...
                      <div className="d-flex">
                          ...
                          <div>
                            <p className="mb-1"> BUSD</p>
                            <p className="text-red mb-0">2547 USD</p>
                          </div>
                        </div>
                      </td>
                      <td align="right">497.0133</td>
                    </tr>
                  </table>
                </div>
              </div>
